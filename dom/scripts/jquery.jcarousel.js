...
jQuery.extend({
    ...
    jcarousel: function(e, o) {
        ...
        var priv = {
            ...
            inAnimation: false,
            autoTimer: null,
            nextClick: function() { priv.next(); $(this).blur(); return false; },
            prevClick: function() { priv.prev(); $(this).blur(); return false; },
            itemFormat: {
                "float":      "left",
                "styleFloat": "left",
                "overflow":   "hidden",
            ...
            prepare: function(e, o) {
                ...
                if (!priv.o.noButtons) {
                    ...
                    jQuery(".jcarousel-prev", priv.scope).css({'z-index': '100'});
                    jQuery(".jcarousel-next", priv.scope).css({'z-index': '100'});
                }
