...
VALUES(
	...
	'".mysql_real_escape_string($person_details_array['identifier'])."',
	'".mysql_real_escape_string($stripped_post_array['identifier'])."',
	NOW(), NOW(),
	'".mysql_real_escape_string($stripped_post_array['job-role-required'])."',
	'".mysql_real_escape_string($stripped_post_array['professional-text-required'])."',
	'".mysql_real_escape_string($stripped_post_array['personal-text-required'])."'
)";
...
Updated = NOW(),
Title = '".mysql_real_escape_string($stripped_post_array['job-role-required'])."',
Text_Corporate = '".mysql_real_escape_string($stripped_post_array['professional-text-required'])."',
Text_Personal = '".mysql_real_escape_string($stripped_post_array['personal-text-required'])."'
WHERE Author_Detail_ID = '".mysql_real_escape_string($stripped_post_array['identifier'])."'";
